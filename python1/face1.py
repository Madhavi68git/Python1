...
reference_images = {}
reference_dir = r"C:\Users\MRV IT SOLUTIONS\Pictures\images"
...
attendance_file ="face recognization.csv"

def mark_attendance(matched_name):
    with open(attendance_file, 'a') as f:
        # current_time = datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        f.write(f"{matched_name},{current_time}\n")
        print(f"Attendance marked for {matched_name} at {current_time}")
